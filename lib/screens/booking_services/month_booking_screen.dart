  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      builder: (context, builder) {
        ...
        var price = context.watch<MonthBookingServicePrv>().price;
          ...
          body: ListView(
            children: [
              ...
              PrimaryDropDown(
                ...
                onChange: (v) =>
                    context.watch<MonthBookingServicePrv>().onChangeArea(v),
              ...
              vpad(8),
              ...service.list_hours_of_operation_per_day!.asMap().entries.map(
                    (e) => RadioListTile<int>(
                      title: Text(
                      ...
                      groupValue: option,
                      onChanged: (v) =>
                          context.read<MonthBookingServicePrv>().selectTime(v),
                    ),
                  ),
              vpad(16),
              PrimaryDropDown(
                ...
                selectList: shelflifeList
                    ...
                    .map(
                      (i) => DropdownMenuItem(
                        child: Text(
                          '${i.value.shelfLife?.use_time} ${S.of(context).month}${PrfData.shared.getLanguage() == 1 && (i.value.shelfLife?.use_time ?? 0) >= 2 ? "s" : ""} ',
                        ),
                        value: i.key,
                      ),
                    )
                ...
                isRequired: true,
                onChange: (v) =>
                    context.read<MonthBookingServicePrv>().onChangeShelfLife(v),
              ),
              vpad(16),
              PrimaryTextField(
                labelStyle: txtBold(12),
                ...
                isRequired: true,
                initialValue: formatCurrency.format(price),
                enable: false,
              ...
              PrimaryTextField(
                labelStyle: txtBold(12),
                controller:
                    context.watch<MonthBookingServicePrv>().startDateController,
              ...
              PrimaryTextField(
                labelStyle: txtBold(12),
                controller:
                    context.watch<MonthBookingServicePrv>().endDateController,
