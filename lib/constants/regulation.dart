...
var consRe =
    '<p  style="text-align:justify;"><strong>Điều 1</strong>:&nbsp;<br>– Nhà thầu tư vấn đủ điều kiện năng lực được tổng thầu thuê giám sát (với điều kiện tổng thầu có quyền thực hiện giám sát)<br>+ Đối với các công trình đầu tư xây dựng bằng nguồn vốn ngân sách nhà nước và vốn nhà nước ngoài ngân sách:<br>– Tổ chức giám sát thi công xây dựng công trình phải độc lập với các nhà thầu thi công xây dựng và các nhà thầu chế tạo, sản xuất, cung ứng vật liệu, sản phẩm, cấu kiện, thiết bị sử dụng cho công trình<br>Tổ chức giám sát thi công xây dựng không được tham gia kiểm định chất lượng công trình xây dựng do mình giám sát</p><p>&nbsp;</p>';
