...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(plate) => "Bạn có chắc chắn hủy phương tiện ${plate} không?";

  static String m4(letter) =>
      "Bạn có chắc chắn muốn xóa phiếu [${letter}] không?";

  static String m5(delete) => "Bạn có chắc chắn muốn xóa [${delete}] không?";

  static String m6(card) => "Bạn có muốn khóa thẻ [${card}] không?";
  ...
  static String m11(nameser) => "Chỉnh sửa đăng ký dịch vụ ${nameser}";
  ...
  static String m14(nameser) => "Đăng ký dịch vụ ${nameser}";

  static String m15(eName) => "Bạn đã xác nhận tham gia [${eName}] thành công";

  static String m16(service) => "Dịch vụ ${service}";

  static String m17(person, build) =>
      "bạn đã thêm ${person} vào căn hộ ${build}. Vui lòng chờ BQL phê duyệt";

  static String m18(p) => "Bạn đã thanh toán cho ${p} thành công ";

  static String m19(month, year) =>
      "Tổng lượng nước thiêu thụ tháng ${month}/${year}";

  static String m20(to) => "Chúng tôi đã gửi cho bạn mã đến: ${to}";
