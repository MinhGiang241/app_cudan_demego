...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(c) => "Do you want to cancel letter ${c}";

  static String m6(c) =>
      "Do you want to cancel the construction suspension ticket ${c}";

  static String m7(code) => "Do you want to cancel request letter [${code}]";

  static String m8(plate) => "Do you want to cancel transport ${plate}?";

  static String m9(name) =>
      "Do you want to change schedule of handover, old  schedule for apartment [${name}] will be cancel?";

  static String m10(letter) => "Do you want to delete letter [${letter}]?";

  static String m11(delete) => "Do you want to delete [${delete}]?";

  static String m12(card) => "Do you want to lock card [${card}]?";

  static String m13(code) => "Do you want to report missing card ${code}?";

  static String m14(code) => "Do you want to report missing card ${code}?";

  static String m15(eventName) =>
      "Do you want to participate in [${eventName}]?";

  static String m16(code) => "Do you want to refuse letter [${code}] ?";

  static String m17(approved) =>
      "Do you want to send to approve [${approved}]?";

  static String m18(c) =>
      "Handover list has ${c} item not pass .Do you want to confirm handover.";

  static String m19(nameser) => "Edit registration service ${nameser}";
  ...
  static String m22(s) => "Value is not greater than ${s}";

  static String m23(numAsset) =>
      "Hand over list has ${numAsset} assets not pass";

  static String m24(nameser) => "Registration service ${nameser}";

  static String m25(eName) => "Paticipate event [${eName}] successfully";

  static String m26(service) => "Service ${service}";
  ...
  static String m31(ap) => "You already hand over for ${ap} successfully";

  static String m32(p) => "Make payment for ${p} successfully";

  static String m33(month, year) =>
      "Total consumed water month ${month}/${year}";

  static String m34(to) => "We sent otp code to :${to}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "bill_from_to": m0,
        "bill_history": MessageLookupByLibrary.simpleMessage("Bill history"),
        ...
        "can_schedule": MessageLookupByLibrary.simpleMessage("Cancel schedule"),
        "can_schedule_hand_over":
            MessageLookupByLibrary.simpleMessage("Cancel handover schedule"),
        "can_trans":
            MessageLookupByLibrary.simpleMessage("Cancel transportation card"),
        "can_trans_res":
        ...
        "child_ticket_num":
            MessageLookupByLibrary.simpleMessage("Child ticket number"),
        ...
        "dependent_host":
            MessageLookupByLibrary.simpleMessage("Dependent host"),
        "dependent_person":
            MessageLookupByLibrary.simpleMessage("Dependent person"),
        "dependent_rent":
            MessageLookupByLibrary.simpleMessage("Dependent rent"),
        ...
        "elec_details":
            MessageLookupByLibrary.simpleMessage("Electricity details"),
        "elec_index": MessageLookupByLibrary.simpleMessage("Electricity index"),
        "elect_consume_chart":
        ...
        "end_date_stop":
            MessageLookupByLibrary.simpleMessage("End date of pause"),
        ...
        "expired_date_create":
            MessageLookupByLibrary.simpleMessage("extended expired date"),
        "expired_date_new":
            MessageLookupByLibrary.simpleMessage("New expired date"),
        "expired_date_old":
        ...
        "high_school_degree":
            MessageLookupByLibrary.simpleMessage("High school degree"),
        "his_reg_service":
        ...
        "issue_res_card":
            MessageLookupByLibrary.simpleMessage("Issued resident card"),
        "item_list_not_empty":
        ...
        "material0": MessageLookupByLibrary.simpleMessage("Material"),
        "material_details":
        ...
        "meter_code": MessageLookupByLibrary.simpleMessage("Meter code"),
        ...
        "new_index": MessageLookupByLibrary.simpleMessage("New index"),
        ...
        "no_stop_letter": MessageLookupByLibrary.simpleMessage(
        ...
        "old_index": MessageLookupByLibrary.simpleMessage("Old index"),
        ...
        "refuse_letter": MessageLookupByLibrary.simpleMessage("Refuse letter"),
        "reg_cancel":
        ...
        "report_missing_card":
            MessageLookupByLibrary.simpleMessage("Report missing card"),
        ...
        "res_name": MessageLookupByLibrary.simpleMessage("Resident name"),
        ...
        "start_date_stop":
            MessageLookupByLibrary.simpleMessage("Pause start date"),
        ...
        "stop_construction": MessageLookupByLibrary.simpleMessage(
        ...
        "success_cancel_cons_stop": MessageLookupByLibrary.simpleMessage(
        ...
        "success_cancel_trans": MessageLookupByLibrary.simpleMessage(
        ...
        "weekend_child_ticket_num":
            MessageLookupByLibrary.simpleMessage("Weekend child ticket number"),
        "weekend_ticket_num":
            MessageLookupByLibrary.simpleMessage("Weekend ticket number"),
